"""
Django settings for vetclinic_site project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-lr5-vetclinic-local-dev-key')
...
ROOT_URLCONF = 'vetclinic_site.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'clinic.context_processors.site_time',
            ],
        },
    },
]

WSGI_APPLICATION = 'vetclinic_site.wsgi.application'
